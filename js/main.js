...
// Convertir el texto ingresado por el usuario a minúsculas para hacer coincidencias insensibles a mayúsculas y minúsculas
let diaMinusculas = dia.toLowerCase();

// Evaluar el día de la semana y proporcionar una respuesta
switch (diaMinusculas) {
    ...
    case "jueves":
    case "viernes":
        console.log("¡Es un día lectivo de trabajo!");
        break;
    case "sábado":
    case "domingo":
